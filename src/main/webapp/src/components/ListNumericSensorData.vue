...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "NumericValue", sortable: true, value: "numericValue" },
      ],
    };
  },
  computed: {
    sensordata1() {
      return this.$store.getters['datas/getAllNumericSensorDatas'];
    },
  },
  watch: {
  ...
  mounted() {
    this.$store.dispatch("datas/getNumericDatasSensors",this.SensorNumber);
  },
};
